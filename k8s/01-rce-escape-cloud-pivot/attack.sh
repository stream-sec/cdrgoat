...
info "To destroy the scenario environment:"
printf "  kubectl delete -f deploy.yaml\n\n"
info "To remove rootkit artifacts from the node (requires host access):"
printf "  rmmod cdrgoat_rootkit                              # unload module\n"
printf "  rm -f /etc/modules-load.d/cdrgoat_rootkit.conf     # remove persistence\n"
printf "  rm -rf /lib/modules/*/kernel/drivers/misc/cdrgoat* # remove .ko file\n"
printf "  rm -rf /tmp/cdrgoat_lkm /tmp/.hidden_cdrgoat      # remove build artifacts\n"
printf "  depmod                                             # rebuild module database\n\n"
